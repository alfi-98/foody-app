  ...
  return (
    <View className="bg-[#00CCBB] flex-1">
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28">
        <Image
          source={{
            uri: "/Users/imac/Documents/alfiDev/Foody/foody-app/assets/pro.jpeg",
          }}
          className="h-12 w-12 bg-blue-300 p-4 rounded-full ml-5"
        />
        <View className="flex-1">
          <Text className="text-lg">Alfi Mostak</Text>
